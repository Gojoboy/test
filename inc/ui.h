...
typedef struct s_chats_list_page{
    ...
    /*GObject *search_revealer;
    //GtkWidget *search_box;
    GObject *close_search_button; // (image?)
    GObject *search_entry;
    char *search_prev;
    GObject *search_button;

    //GtkWidget *bottom_box;
    //GtkWidget *contacts_button;
    GObject *add_chat_button;
    GObject *profile_button;
    GObject *find_button;
    //GtkWidget *settings_button;*/

    // GObject *main_box; // (listbox)
    t_chat_widget **chatarr;
    int chatarr_count;
    int chatarr_size;

    // GObject *search_scroller;
    // GObject *search_list; // (listbox)
...
typedef struct s_chat_page {
    ...
    t_overlay *profile_overlay;
    /*//GtkWidget *top_box;
    GObject *exit_chat_button;
    GObject *profile_button;
    //GtkWidget *chat_box;
    //GtkWidget *chat_profile_image;
    GObject *name_label;
    GObject *online_label;
    ...
    GObject *repfor_revealer;
    GObject *repfor_label;

    GObject *attachment_revealer;
    GObject *attachment_label;

    //GtkWidget *bottom_box;
    GObject *attach_button;
    GObject *main_entry;
    GObject *send_button;
